...
export class DeterministicDeployer {
  ...
  static getAddress(
    ...
    return DeterministicDeployer.getDeterministicDeployAddress(
      ctrCode,
      salt,
      params,
    );
  ...
  static async deploy(
    ...
    return await DeterministicDeployer.instance.deterministicDeploy(
      ctrCode,
      salt,
      params,
    );
  ...
  async deployFactory(): Promise<void> {
    ...
    const bal = await this.provider.getBalance(
      DeterministicDeployer.deploymentSignerAddress,
    );
    const neededBalance = BigNumber.from(
      DeterministicDeployer.deploymentGasLimit,
    ).mul(DeterministicDeployer.deploymentGasPrice);
  ...
  async deterministicDeploy(
    ...
    const addr = DeterministicDeployer.getDeterministicDeployAddress(
      ctrCode,
      salt,
      params,
    );
