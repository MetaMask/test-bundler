...
import type { BundlerTracerResult, ExitInfo } from './BundlerCollectorTracer';
import { bundlerCollectorTracer } from './BundlerCollectorTracer';
import { debug_traceCall } from './GethTracer';
import { tracerResultParser } from './TracerResultParser';
import { CodeHashGetter__factory } from '../contract-types';
...
export class ValidationManager {
  constructor(readonly entryPoint: IEntryPoint, readonly unsafe: boolean) {}
  ...
  async _geth_traceCall_SimulateValidation(
    ...
    const { data } = lastResult as ExitInfo;
